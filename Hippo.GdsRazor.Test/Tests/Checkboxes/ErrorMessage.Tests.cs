...
public class ErrorMessageTests : ClientBase<Startup>
{
    ...
    {
        var response = await Navigate("/Checkboxes/WithErrorMessage");
    ...
    {
        var response = await Navigate("/Checkboxes/WithErrorAndIdPrefix");
        var component = response.QuerySelector(".govuk-error-message");
    ...
    {
        var response = await Navigate("/Checkboxes/WithFieldsetAndErrorMessage");
    ...
    {
        var response = await Navigate("/Checkboxes/WithErrorMessageAndFieldsetDescribedBy");
        var fieldset = response.QuerySelector(".govuk-fieldset");
        var component = response.QuerySelector(".govuk-error-message");
    ...
    {
        var response = await Navigate("/Checkboxes/WithErrorMessageAndHintsOnItems");
