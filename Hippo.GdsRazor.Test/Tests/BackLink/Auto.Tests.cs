...
namespace Hippo.GdsRazor.Test.Tests.BackLink;
...
public class AutoTests : ClientBase<Startup>
{
    ...
    [Theory, GdsAutoData]
    public async void AllPropertiesAreUsed(BackLinkModel model)
    {
        var html = await AutoFixtureResults("BackLink", model);
